...
在 Finalshell 终端执行(本服务器是 Ubuntu 22,直接复制下面这条**宝塔官网下载页的官方稳定版安装命令**):
...
> - 结尾的 `5x59vxy56` 是官方安装命令自带的参数,原样保留,不要删。
> - 以后重装服务器时,以宝塔官网下载页 [bt.cn](https://www.bt.cn/new/download.html) 复制的最新命令为准。
> - CentOS 系统另有对应的 yum 安装命令;本教程按 Ubuntu 22 走,不涉及。

> 安装过程约 1~3 分钟,最后会打印(示例):
>
> ```
